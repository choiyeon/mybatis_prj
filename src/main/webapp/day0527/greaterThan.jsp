...
<input type="hidden" name="link" value="day0527/greaterThan"/><!-- include할 파라메터 설정 -->
<h2>입력되는 연봉보다 많이 수령하는 사원정보 조회 사원번호 조회</h2>
<label>연봉</label>
...
<div>
	<c:if test="${ not empty param.sal }">
		...
		<c:catch var="e">
			...
			List<EmpDomain> list = emp4DAO.greaterThan(sal);
